...
img::EasyImage generate_image(const ini::Configuration &configuration)
{
    ...
    if(name=="2DLSystem") {
    ...
    else if(name=="Wireframe" or name=="ZBufferedWireframe" or name=="ZBuffering"){
        Figures3D figs;
        ...
        for(int i=0;i<nrFigures;i++){
            ...
            if(nameFig=="FractalCube" or nameFig=="FractalTetrahedron" or nameFig=="FractalOctahedron" or nameFig=="FractalIcosahedron" or nameFig=="FractalDodecahedron"){
                double fractalScale=sectieFig["fractalScale"].as_double_or_die();
                int nr_iterations=sectieFig["nrIterations"].as_int_or_die();
                Figures3D fractal;
        ...
        if(name=="Wireframe") {
            ...
            for(Figure fig:figs){
                ...
                for(auto vlak:fig.faces){
                    ...
                    ZBuffer::draw_zbuf_triangle(buffer,image,A,B,C,d,dx,dy,fig.color);
                }
            }
